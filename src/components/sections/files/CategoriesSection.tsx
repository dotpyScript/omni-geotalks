...
export default function CategoriesSection({
  ...
  subtitle =
    "IEGS webinars span the full spectrum of geospatial science — from foundational mapping and remote sensing to cutting-edge drone technology, AI-powered spatial analytics, Digital Twin city modelling, and petroleum geospatial intelligence.",
  onCategorySelect,
  ...
  return (
    <section
      className={[
        ...
        // ── Colour & font ──────────────────────────────────────────────
        "bg-[#0d1118] text-[#f0ede6] font-['DM_Sans',sans-serif]",
        // ── Spacing ────────────────────────────────────────────────────
        "px-[60px] py-[120px] pb-[130px]",
        // ── Responsive padding ─────────────────────────────────────────
        "max-lg:px-8 max-lg:py-20 max-lg:pb-[100px]",
        "max-sm:px-5 max-sm:py-[60px] max-sm:pb-20",
      ].join(" ")}
