...
export const WEBINARS: Webinar[] = [
  {
    ...
    description: "Deep dive into cutting-edge GIS methodologies transforming how cities plan and manage critical infrastructure assets using AI-driven spatial analysis.",
  ...
  },
  {
    ...
    description: "How UAV technology is revolutionising real-time monitoring of oil and gas pipelines across the Niger Delta region with Digital Twin integration.",
  ...
  },
  {
    ...
    description: "How geospatial digital twins are reducing exploration risk and accelerating field development decisions at NNPC.",
