    ...
    >
      ...
      >
        ...
        >
          ...
          <h2
            className={[
              "font-['Cormorant_Garamond',serif] italic font-light leading-[1.0]",
              "text-[clamp(3rem,6vw,5.5rem)]",
              "text-[#e8c97e]",
            ].join(" ")}
          >
        ...
        >
          ...
          knowledge platform connecting practitioners, governments, energy companies 
          and academic institutions through world-class webinar education — built 
        ...
        <div className="relative z-[3] mt-auto p-8 max-md:p-5">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {["AI-Powered", "Digital Twin", "Pan-African", "Expert-Led"].map((tag) => (
                <span
                  key={tag}
                  className={[
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <div className="flex items-center gap-1.5 justify-end mt-1">
                  <span className="w-[6px] h-[6px] rounded-full bg-[#00e5a0] animate-ping absolute" aria-hidden="true" />
                  <span className="w-[6px] h-[6px] rounded-full bg-[#00e5a0] relative" aria-hidden="true" />
